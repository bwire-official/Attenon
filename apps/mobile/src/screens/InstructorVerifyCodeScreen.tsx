...
interface InstructorVerifyCodeScreenProps {
    email: string;
    onBack?: () => void;
    onCodeVerified?: () => void;
}

export const InstructorVerifyCodeScreen = ({ email, onBack, onCodeVerified }: InstructorVerifyCodeScreenProps) => {
        ...
        <View style={styles.container}>
            ...
            <View style={[styles.headerSection, {
                ...
                <View style={styles.headerTextContainer}>
                    <Text style={[styles.helloText, { color: colors.white }]}>Enter</Text>
                    <Text style={[styles.signInText, { color: colors.white }]}>Code</Text>
                </View>
            </View>
                ...
                >
                    ...
                    >
                        {loading ? (
                            ...
                            <Text style={[styles.verifyButtonText, { color: colors.white }]}>VERIFY CODE</Text>
                        )}
                    </TouchableOpacity>
